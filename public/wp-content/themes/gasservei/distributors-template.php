                    ...
                    <div class="row">
                      <div class="large-12 columns">
                          <div class="entry-content">
                            <!-- Mapa -->
                            <h2><?php echo __('Mapa de distribuidores'); ?></h2>
                            <?php  include_once('modules/custom-posts/mapa.php'); ?>
                            <!-- Accordion -->
                            <h2><?php echo __('Encuentra tu distribuidor más cercano'); ?></h2>
                            <?php  include_once('modules/custom-posts/distributors-accordion.php'); ?>
                          </div><!-- .entry-content -->
