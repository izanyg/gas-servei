...
<div id="primary" class="content-area shop-page shop-category-page <?php echo esc_attr($shop_sidebar_class); ?>">
	...
	<?php if( $shop_header ) : ?>
		...
		<div class="woocommerce-products-header shop_header <?php if ($category_header_src != '' || (is_shop() && $page_header_src != "")) : ?>with_featured_img<?php endif; ?>">
			...
			<video id="background-video" autoplay loop muted>
				<source src="<?php echo get_stylesheet_directory_uri() ?>/videos/video_cat.mp4" type="video/mp4">
			</video>
			...
			<div id="content" class="site-content" role="main">
				<div class="row">
						...
						<?php elseif( 'subcategories' != $display_mode || ( 'subcategories' === $display_mode && 'original_grid' === Shopkeeper_Opt::getOption( 'category_style', 'styled_grid' ) ) ) : ?>
							...
							<?php if( woocommerce_product_loop() || have_posts() ) : ?>
								<div class="large-12 mobile-columns-<?php echo Shopkeeper_Opt::getOption( 'mobile_columns', 2 ); ?> ">
									...
									?>
										<h2 class="archive-section"><?php _e('Subcategories', 'gasservei'); ?></h2>
									...
									if( have_posts() ) {
										echo '<h2 class="archive-section">' . __('Products', 'gasservei') . '</h2>';
					...
					<?php 
						...
						if ( $page )
						{
							echo '<div id="cat_footer">';
							$blocks = parse_blocks($page[0]->post_content);
