...
if ( $product->is_on_sale() )   $sk_product_class .= ' isonsale';
...
<li <?php wc_product_class( $sk_product_class, $product ); ?>>
    ...
    <a href="<?php echo esc_url( apply_filters( 'woocommerce_loop_product_link', get_the_permalink(), $product ) ); ?>" class="view-product"><?php _e('View product', 'gasservei'); ?> </a>
